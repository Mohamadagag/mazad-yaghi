...
//                 <h2 className="mt-2 text-2xl font-semibold text-[#101316]">
//                   {product.bidder.name}
//                 </h2>
...
//                 <p className="text-xs text-[#76818b]">Current amount</p>
...
//               <div className="rounded-md bg-[#f7f8fb] p-4">
//                 <p className="text-xs text-[#76818b]">Item</p>
...
//           <AuctionTimer onSold={handleSold} />
...
//                 className="flex-1 min-h-12 rounded-md border border-black/15 bg-white px-4 text-sm font-semibold text-[#101316] hover:bg-[#f7f8fb]"
//               >
//                 Close
//               </button>
...
//                 }}
//                 disabled={currentIndex === products.length - 1}
//                 className="flex-1 min-h-12 rounded-md bg-[#101316] px-4 text-sm font-semibold text-white hover:bg-[#263039] disabled:cursor-not-allowed disabled:opacity-40"
//               >
//                 Next Item
//               </button>
//             </div>
